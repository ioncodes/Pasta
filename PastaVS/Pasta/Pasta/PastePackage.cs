//------------------------------------------------------------------------------
// <copyright file="PastePackage.cs" company="Company">
...
namespace Pasta
{
    ...
    [Guid(PastePackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class PastePackage : Package
    {
        /// <summary>
        /// PastePackage GUID string.
        /// </summary>
        public const string PackageGuidString = "b44cf701-05e4-4a22-a13d-178352b3e703";
